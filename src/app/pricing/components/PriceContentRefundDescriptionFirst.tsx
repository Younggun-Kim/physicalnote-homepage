export default function PriceContentRefundDescriptionFirst() {
  ...
  return (
    <p className={pStyle}>
      ...
      <span className={'font-sans font-normal text-gray1 text-2xs sm:text-base'}>&middot; 월 결제 구독자:</span>
      <span className={'font-sans font-normal text-gray1 text-2xs sm:text-base'}>
        &emsp;&middot; 구독 해지 시 다음 정기 결제일부터 요금이 청구되지 않으며, 그 전까지는 정상적으로 서비스를 이용할
        수 있습니다.
      </span>
      <span className={'font-sans font-normal text-gray1 text-2xs sm:text-base'}>&middot; 연 결제 구독자:</span>
      <span className={'font-sans font-normal text-gray1 text-2xs sm:text-base'}>
      ...
      <span className={'font-sans font-normal text-gray1 text-2xs sm:text-base'}>1. 청약 철회 가능 기간</span>
      <span className={'font-sans font-normal text-gray1 text-2xs sm:text-base'}>
      ...
      <span className={'font-sans font-normal text-gray1 text-2xs sm:text-base'}>1. 예외 사항</span>
      <span className={'font-sans font-normal text-gray1 text-2xs sm:text-base'}>
