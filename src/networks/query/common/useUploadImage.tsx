...
import UploadImageResponseDto from '@/networks/dto/common/uploadImageResponseDto';
import UploadImageRequestDto from '@/networks/dto/common/uploadImageRequestDto';
